...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2021 at 08:58 AM
...
(1, 40, 'Anandu', 'Present', 'Python', '2021-01-16');
...
INSERT INTO `marks` (`id`, `sub1`, `sub2`, `sub3`, `sub4`, `sub5`, `sub6`, `lab1`, `lab2`) VALUES
...
(11, 'TKM19MCA006', 'ARYA RAJAN', 'MCA', 1051, 999587664, 'MCA2K19A', '2016-2020'),
...
--
ALTER TABLE `course`
  MODIFY `c_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=388;
